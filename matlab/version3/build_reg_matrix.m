...
for i = 1:u_n_inter
    ...
    for k = 1:n_points
        ...
        n = n+1;
        q_u_point(n) = up;
        u_point_val(:,n) = splinebasevec(u_knots,up,0);
        ud_point_val(:,n) = splinebasevec(u_knots,up,1);  
    end
end
...
for i = 1:v_n_inter
    ...
    for k = 1:n_points
        ...
        n = n+1;
        q_v_point(n) = vp;
        v_point_val(:,n) = splinebasevec(v_knots,vp,0);
        vd_point_val(:,n) = splinebasevec(v_knots,vp,1);
    end
end
